        ...
        <footer className="bg-blue-950 text-slate-300 relative overflow-hidden">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <ul className="space-y-3 text-sm">
                            {[
                                { name: "Paslanmaz Sac", path: "/urunler/sac" },
                                { name: "Paslanmaz Profil", path: "/urunler/profil" },
                                { name: "Paslanmaz Boru", path: "/urunler/boru" },
                                { name: "Paslanmaz Köşebent", path: "/urunler/kosebent" },
                                { name: "Paslanmaz Lama", path: "/urunler/lama" },
                                { name: "Fittings", path: "/urunler/fittings" },
                            ].map((link) => (
                                <li key={link.name}>
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <ul className="space-y-3 text-sm">
                            <li><Link href="/kurumsal" className="text-slate-400 hover:text-white transition-colors">Hakkımızda</Link></li>
                            <li><Link href="/kurumsal#kalite" className="text-slate-400 hover:text-white transition-colors">Kalite Belgeleri</Link></li>
            ...
            <div className="border-t border-blue-800/60 bg-blue-950">
                <div className="container mx-auto px-4 py-6 flex flex-col md:flex-row justify-between items-center text-xs text-slate-500 font-medium">
                    <p>© {new Date().getFullYear()} Servis Paslanmaz Metal İnş. San. Ve Tic. Ltd. Şti. Tüm hakları saklıdır.</p>
