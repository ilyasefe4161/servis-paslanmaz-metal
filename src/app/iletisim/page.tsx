        ...
        <div className="min-h-screen bg-slate-50 pb-24">
            ...
            <div className="container mx-auto px-4 -mt-16 relative z-20">
                            ...
                            <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true }} className="space-y-8 relative z-10">
                                ...
                                <motion.div variants={fadeInUp} className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-500 text-sm">Hafta İçi: 08.00 - 18.00</p>
                                        <p className="text-slate-500 text-sm">Cumartesi: 08.00 - 13.00</p>
                                    </div>
                                </motion.div>
                            </motion.div>
                        </motion.div>
                ...
                <motion.div
                    ...
                    className="mt-12 bg-slate-200 w-full h-[400px] rounded-3xl overflow-hidden relative shadow-lg border border-slate-200"
                >
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.7495685364365!2d29.949328475971697!3d40.74553573556209!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14cb45520aef1c59%3A0x6f2f0bcf446e56cc!2sServis%20Paslanmaz%20Metal!5e0!3m2!1str!2str!4v1775029603024!5m2!1str!2str"
                        className="w-full h-full border-0"
                        allowFullScreen
                        loading="lazy"
                        referrerPolicy="no-referrer-when-downgrade"
                        title="Servis Paslanmaz Metal Google Maps"
                    ></iframe>
                </motion.div>
            </div>
        </div>
