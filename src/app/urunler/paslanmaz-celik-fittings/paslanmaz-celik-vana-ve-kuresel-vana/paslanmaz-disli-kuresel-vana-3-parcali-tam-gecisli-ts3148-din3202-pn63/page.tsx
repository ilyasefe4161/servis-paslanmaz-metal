        ...
        <div className="min-h-screen bg-slate-50 pb-24 font-sans">
            ...
            <div className="relative bg-blue-950 py-24 md:py-32 overflow-hidden border-b border-blue-800">
                <div className="absolute inset-0">
                    <Image src="/products/vana2.png" alt="Paslanmaz Dişli Küresel Vana 3 Parçalı Tam Geçişli TS3148 DIN3202 PN63" fill priority className="object-cover opacity-20 mix-blend-luminosity scale-105" />
                ...
                <div className="container relative z-10 mx-auto px-4 mt-12">
                    ...
                    >
                        ...
                        <h1 className="text-5xl md:text-5xl font-extrabold text-white mb-6 tracking-tight">Paslanmaz Dişli Küresel Vana 3 Parçalı Tam Geçişli TS3148 DIN3202 PN63</h1>
                ...
                >
                    <div className="flex items-center gap-4 mb-8 border-b border-slate-100 pb-6">
                        ...
                        <div style={{ width: "100%", maxWidth: "300px", height: "300px" }} className="relative shrink-0 rounded-xl overflow-hidden shadow-2xl border-4 border-slate-200 group bg-slate-50">
                            <Image
                                src="/products/vana2.png"
                                alt="Paslanmaz Dişli Küresel Vana 3 Parçalı Tam Geçişli TS3148 DIN3202 PN63"
                                fill
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 mb-4">
                            <Button asChild size="lg" variant="outline" className="border-blue-950 text-blue-950 hover:bg-blue-50/50 bg-white font-bold h-14 px-8 rounded-xl shadow-sm transition-all border-2">
                                <a href="/vana2.png" target="_blank" rel="noopener noreferrer">
