...
export default function UrunlerHubPage() {
    const categories = [
        { name: "Paslanmaz Çelik Flanşlar", href: "/urunler/paslanmaz-celik-fittings/paslanmaz-celik-flanslar", desc: "", image: "/flans.jpg" },
        { name: "Paslanmaz Çelik Dişli Fittingler", href: "/urunler/paslanmaz-celik-fittings/paslanmaz-celik-disli-fittingler", desc: "", image: "/fittings-1.jpg" },
        { name: "Paslanmaz Çelik Kaynaklı Fittingsler", href: "/urunler/paslanmaz-celik-fittings/paslanmaz-celik-kaynakli-fittingler", desc: "", image: "/fittings-2.jpg" },
        { name: "Paslanmaz Çelik Vana ve Küresel Vana", href: "/urunler/paslanmaz-celik-fittings/paslanmaz-celik-vana-ve-kuresel-vana", desc: "", image: "/2parcali-disli-kuresel-vana.jpg" },
    ];
