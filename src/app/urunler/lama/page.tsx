...
export default function PaslanmazLamaPage() {
    const columns = [
        { key: "genislik", header: "Genişlik (mm)" },
    ...
    const data = [
        { grade: "304", genislik: "20.00", kalinlik: "5.00", agirlik: "0.79" },
        { grade: "304", genislik: "25.00", kalinlik: "5.00", agirlik: "0.98" },
        { grade: "304", genislik: "30.00", kalinlik: "5.00", agirlik: "1.18" },
        { grade: "304", genislik: "40.00", kalinlik: "10.00", agirlik: "3.14" },
        { grade: "304", genislik: "50.00", kalinlik: "10.00", agirlik: "3.93" },

        { grade: "316", genislik: "30.00", kalinlik: "5.00", agirlik: "1.18" },
        { grade: "316", genislik: "40.00", kalinlik: "5.00", agirlik: "1.57" },
        { grade: "316", genislik: "50.00", kalinlik: "10.00", agirlik: "3.93" },
    ];
            ...
            <div className="relative bg-blue-950 py-24 md:py-32 overflow-hidden border-b border-blue-800">
                ...
                <div className="container relative z-10 mx-auto px-4 mt-12">
                    ...
                    >
                        ...
                        <h1 className="text-5xl md:text-7xl font-extrabold text-white mb-6 tracking-tight">Paslanmaz Lama</h1>
                        <p className="text-xl md:text-2xl text-slate-300 font-light leading-relaxed">
                            Düzlemsel sağlamlık ve sınırsız işleme potansiyeli.
                        </p>
                    </motion.div>
                </div>
            </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        ...
                        >
                            ...
                            <div className="space-y-6 text-slate-600 text-lg leading-relaxed">
                                <p>Dikdörtgen şeklindeki paslanmaz çubuklar olarak bilinen lamalar, talaşlı imalat, endüstriyel mutfak ekipmanları ve süsleme sanayisinin vazgeçilmez temel yapı taşlarındandır.</p>
                                <p>Slit (dilme) lama ve sıcak haddelenmiş gerçek lama seçeneklerimiz, tam otomatik testerelerimizde projelerinize uygun ölçülerde firesiz olarak kesilmektedir.</p>
                            </div>
                            ...
                            <div className="mt-10 grid gap-4">
                                ...
                                <div className="flex items-center text-blue-800 font-bold bg-slate-50 p-4 rounded-xl border border-slate-100 hover:border-red-200 transition-colors">
                                    ...
                                    <span>Hassas Kesim Ölçüleri</span>
                                </div>
                                
                                <div className="flex items-center text-blue-800 font-bold bg-slate-50 p-4 rounded-xl border border-slate-100 hover:border-red-200 transition-colors">
                                    <ShieldCheck className="w-6 h-6 text-red-600 mr-4 shrink-0" />
                                    <span>Talaşlı İmalata Uygun</span>
                                </div>
                                
                                <div className="flex items-center text-blue-800 font-bold bg-slate-50 p-4 rounded-xl border border-slate-100 hover:border-red-200 transition-colors">
                                    <ShieldCheck className="w-6 h-6 text-red-600 mr-4 shrink-0" />
                                    <span>Sıcak Hadde ve Kesme Alternatifleri</span>
                                </div>
                        ...
                        >
                            ...
                            <div className="relative group rounded-3xl shadow-2xl overflow-hidden border border-slate-100 aspect-square md:aspect-[4/3] bg-white">
                                <Image src="/products/paslanmaz-lama.jpg" alt="Paslanmaz Lama" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover transition-transform duration-1000 group-hover:scale-110" />
