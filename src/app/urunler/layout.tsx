...
export default function UrunlerLayout({ children }: { children: React.ReactNode }) {
    ...
    const categories = [
        { name: "Paslanmaz Çelik Sac", href: "/urunler/paslanmaz-celik-sac" },
        { name: "Paslanmaz Çelik Boru", href: "/urunler/paslanmaz-celik-boru" },
        { name: "Paslanmaz Çelik Profil", href: "/urunler/paslanmaz-celik-profil" },
        { name: "Paslanmaz Çelik Çubuk", href: "/urunler/paslanmaz-celik-cubuk" },
        { name: "Paslanmaz Çelik Lama", href: "/urunler/paslanmaz-celik-lama" },
        { name: "Paslanmaz Çelik Köşebent", href: "/urunler/paslanmaz-celik-kosebent" },
        { name: "Paslanmaz Çelik Fittings", href: "/urunler/paslanmaz-celik-fittings" },
    ];
