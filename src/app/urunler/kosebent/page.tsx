...
export default function PaslanmazKosebentPage() {
    ...
    const data = [
        { grade: "304", ebat: "20 x 20", kalinlik: "3.00", agirlik: "0.88" },
        { grade: "304", ebat: "25 x 25", kalinlik: "3.00", agirlik: "1.12" },
        { grade: "304", ebat: "30 x 30", kalinlik: "3.00", agirlik: "1.36" },
        { grade: "304", ebat: "40 x 40", kalinlik: "4.00", agirlik: "2.42" },
        { grade: "304", ebat: "50 x 50", kalinlik: "5.00", agirlik: "3.77" },
        { grade: "304", ebat: "60 x 60", kalinlik: "6.00", agirlik: "5.42" },
    ];
            ...
            <div className="relative bg-blue-950 py-24 md:py-32 overflow-hidden border-b border-blue-800">
                ...
                <div className="container relative z-10 mx-auto px-4 mt-12">
                    ...
                    >
                        ...
                        <h1 className="text-5xl md:text-7xl font-extrabold text-white mb-6 tracking-tight">Paslanmaz Köşebent</h1>
                        <p className="text-xl md:text-2xl text-slate-300 font-light leading-relaxed">
                            L kesitiyle birleştirme ve güçlendirme projelerinizin temeli.
                        </p>
                    </motion.div>
                </div>
            </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        ...
                        >
                            ...
                            <div className="space-y-6 text-slate-600 text-lg leading-relaxed">
                                <p>L formundaki paslanmaz köşebentlerimiz, yapılar arası bağlantılarda, köşelerin desteklenmesinde ve taşıyıcı iskeletlerde maksimum dayanıklılık sağlar.</p>
                                <p>Sıcak haddeleme veya büküm yoluyla elde edilen bu ürünler, özellikle marin, kimya ve asit sanayisinde korozyona karşı üst düzey bir savunma hattı oluşturur. Özel kesim imkanıyla her projeye uyar.</p>
                            </div>
                            ...
                            <div className="mt-10 grid gap-4">
                                ...
                                <div className="flex items-center text-blue-800 font-bold bg-slate-50 p-4 rounded-xl border border-slate-100 hover:border-red-200 transition-colors">
                                    ...
                                    <span>L Formunda Kusursuz Gönye</span>
                                </div>
                                
                                <div className="flex items-center text-blue-800 font-bold bg-slate-50 p-4 rounded-xl border border-slate-100 hover:border-red-200 transition-colors">
                                    <ShieldCheck className="w-6 h-6 text-red-600 mr-4 shrink-0" />
                                    <span>Yüksek Korozyon ve Asit Direnci</span>
                                </div>
                                
                                <div className="flex items-center text-blue-800 font-bold bg-slate-50 p-4 rounded-xl border border-slate-100 hover:border-red-200 transition-colors">
                                    <ShieldCheck className="w-6 h-6 text-red-600 mr-4 shrink-0" />
                                    <span>Kolay Kaynaklanabilirlik</span>
                                </div>
                        ...
                        >
                            ...
                            <div className="relative group rounded-3xl shadow-2xl overflow-hidden border border-slate-100 aspect-square md:aspect-[4/3] bg-white">
                                <Image src="/products/paslanmaz-kosebent.jpg" alt="Paslanmaz Köşebent" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover transition-transform duration-1000 group-hover:scale-110" />
