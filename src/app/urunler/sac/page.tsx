...
export default function PaslanmazSacPage() {
    const columns = [
        { key: "kalinlik", header: "Kalınlık (mm)" },
        { key: "ebat", header: "Ebat (mm)" },
        { key: "yuzey", header: "Yüzey" },
        { key: "agirlik", header: "Ağırlık (kg/plaka)" },
    ];

    const grades = ["304", "316", "430"];

    // Mock data representing standard steel sheet sizes
    const data = [
        { grade: "304", kalinlik: "1.00", ebat: "1000 x 2000", yuzey: "2B / Mat", agirlik: "16.00" },
        { grade: "304", kalinlik: "1.20", ebat: "1000 x 2000", yuzey: "2B / Mat", agirlik: "19.20" },
        { grade: "304", kalinlik: "1.50", ebat: "1250 x 2500", yuzey: "BA / Parlak", agirlik: "37.50" },
        { grade: "304", kalinlik: "2.00", ebat: "1500 x 3000", yuzey: "SB / Taşlı", agirlik: "72.00" },

        { grade: "316", kalinlik: "1.50", ebat: "1000 x 2000", yuzey: "2B / Mat", agirlik: "24.00" },
        { grade: "316", kalinlik: "2.00", ebat: "1250 x 2500", yuzey: "2B / Mat", agirlik: "50.00" },
        { grade: "316", kalinlik: "3.00", ebat: "1500 x 3000", yuzey: "1D / Sıcak", agirlik: "108.00" },

        { grade: "430", kalinlik: "1.00", ebat: "1000 x 2000", yuzey: "BA / Parlak", agirlik: "16.00" },
        { grade: "430", kalinlik: "1.50", ebat: "1250 x 2500", yuzey: "BA / Parlak", agirlik: "37.50" },
    ];
            ...
            <div className="relative bg-blue-950 py-24 md:py-32 overflow-hidden border-b border-blue-800">
                ...
                <div className="container relative z-10 mx-auto px-4 mt-12">
                    ...
                    >
                        ...
                        <h1 className="text-5xl md:text-7xl font-extrabold text-white mb-6 tracking-tight">Paslanmaz Sac</h1>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        ...
                        >
                            ...
                            <div className="space-y-6 text-slate-600 text-lg leading-relaxed">
                                <p>Paslanmaz sac ürünlerimiz, yüksek korozyon direnci ve optimum şekillendirilebilirlik özellikleri sayesinde mutfak eşyalarından ağır sanayi tesislerine kadar her alanda güvenle kullanılmaktadır.</p>
                                <p>Soğuk ve sıcak haddelenmiş (CR / HR) sac alternatiflerimiz, 2B, BA, 4N (Taşlı) gibi farklı yüzey kalitelerinde stoklarımızda her an mevcuttur. Rulodan boya kesim hizmetimizle ölçü firenizi sıfıra indiriyoruz.</p>
                            </div>
                            ...
                            <div className="mt-10 grid gap-4">
                                ...
                                <div className="flex items-center text-blue-800 font-bold bg-slate-50 p-4 rounded-xl border border-slate-100 hover:border-red-200 transition-colors">
                                    ...
                                    <span>Yüksek Korozyon Direnci</span>
                                </div>
                                
                                <div className="flex items-center text-blue-800 font-bold bg-slate-50 p-4 rounded-xl border border-slate-100 hover:border-red-200 transition-colors">
                                    <ShieldCheck className="w-6 h-6 text-red-600 mr-4 shrink-0" />
                                    <span>Kolay Şekillendirme ve Kaynak</span>
                                </div>
                                
                                <div className="flex items-center text-blue-800 font-bold bg-slate-50 p-4 rounded-xl border border-slate-100 hover:border-red-200 transition-colors">
                                    <ShieldCheck className="w-6 h-6 text-red-600 mr-4 shrink-0" />
                                    <span>2B, BA, SB, HL Yüzey Seçenekleri</span>
                                </div>
                        ...
                        >
                            ...
                            <div className="relative group rounded-3xl shadow-2xl overflow-hidden border border-slate-100 aspect-square md:aspect-[4/3] bg-white">
                                <Image src="/products/paslanmaz-sac.jpg" alt="Paslanmaz Sac" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover transition-transform duration-1000 group-hover:scale-110" />
