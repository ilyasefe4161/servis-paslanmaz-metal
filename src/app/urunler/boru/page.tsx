...
export default function PaslanmazBoruPage() {
    const columns = [
        { key: "cap", header: "Dış Çap (mm)" },
        { key: "kalinlik", header: "Et Kalınlığı (mm)" },
        { key: "tip", header: "Boru Tipi" },
    ...
    const data = [
        { grade: "304", cap: "21.3", kalinlik: "2.00", tip: "Dikişli TIG", agirlik: "0.96" },
        { grade: "304", cap: "33.7", kalinlik: "2.00", tip: "Dikişli TIG", agirlik: "1.58" },
        { grade: "304", cap: "42.4", kalinlik: "3.00", tip: "Dikişsiz (Çekme)", agirlik: "2.95" },
        { grade: "304", cap: "60.3", kalinlik: "2.00", tip: "HF (Dekoratif)", agirlik: "2.91" },

        { grade: "316", cap: "26.9", kalinlik: "2.00", tip: "Dikişli TIG", agirlik: "1.24" },
        { grade: "316", cap: "48.3", kalinlik: "3.00", tip: "Dikişsiz (Çekme)", agirlik: "3.40" },
        { grade: "316", cap: "88.9", kalinlik: "2.00", tip: "Dikişli TIG", agirlik: "4.35" },
    ];
            ...
            <div className="relative bg-blue-950 py-24 md:py-32 overflow-hidden border-b border-blue-800">
                ...
                <div className="container relative z-10 mx-auto px-4 mt-12">
                    ...
                    >
                        ...
                        <h1 className="text-5xl md:text-7xl font-extrabold text-white mb-6 tracking-tight">Paslanmaz Boru</h1>
                        <p className="text-xl md:text-2xl text-slate-300 font-light leading-relaxed">
                            Yüksek basınca ve zorlu koşullara dayanıklı endüstriyel çözüm.
                        </p>
                    </motion.div>
                </div>
            </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        ...
                        >
                            ...
                            <div className="space-y-6 text-slate-600 text-lg leading-relaxed">
                                <p>Dikişli ve çekme (dikişsiz) paslanmaz borularımız, petro-kimya tesisleri, enerji santralleri ve gıda üretim hatları gibi kritik süreçlerde sorunsuz sıvı ve gaz transferi sağlar.</p>
                                <p>TIG veya HF kaynak yöntemleriyle üretilen dikişli borularımız dekoratif beklentileri karşılarken, yüksek güvenlik gerektiren prosesler için çekme boru tedariğimiz de bulunmaktadır.</p>
                            </div>
                            ...
                            <div className="mt-10 grid gap-4">
                                ...
                                <div className="flex items-center text-blue-800 font-bold bg-slate-50 p-4 rounded-xl border border-slate-100 hover:border-red-200 transition-colors">
                                    ...
                                    <span>Dikişsiz ve Dikişli Seçenekler</span>
                                </div>
                                
                                <div className="flex items-center text-blue-800 font-bold bg-slate-50 p-4 rounded-xl border border-slate-100 hover:border-red-200 transition-colors">
                                    <ShieldCheck className="w-6 h-6 text-red-600 mr-4 shrink-0" />
                                    <span>Yüksek Basınç Dayanımı</span>
                                </div>
                                
                                <div className="flex items-center text-blue-800 font-bold bg-slate-50 p-4 rounded-xl border border-slate-100 hover:border-red-200 transition-colors">
                                    <ShieldCheck className="w-6 h-6 text-red-600 mr-4 shrink-0" />
                                    <span>Mükemmel Akışkan İletimi</span>
                                </div>
                        ...
                        >
                            ...
                            <div className="relative group rounded-3xl shadow-2xl overflow-hidden border border-slate-100 aspect-square md:aspect-[4/3] bg-white">
                                <Image src="/products/paslanmaz-boru.jpg" alt="Paslanmaz Boru" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover transition-transform duration-1000 group-hover:scale-110" />
