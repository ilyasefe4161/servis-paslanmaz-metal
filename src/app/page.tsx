...
export default function Home() {
  const categories = [
    { name: "Paslanmaz Sac", href: "/urunler/sac", desc: "Soğuk ve sıcak haddelenmiş plakalar", image: "/products/paslanmaz-sac.jpg" },
    { name: "Paslanmaz Profil", href: "/urunler/profil", desc: "Kare ve dikdörtgen yapı profilleri", image: "/products/paslanmaz-profil.jpg" },
    { name: "Paslanmaz Boru", href: "/urunler/boru", desc: "Dikişli, dikişsiz ve dekoratif", image: "/products/paslanmaz-boru.jpg" },
    { name: "Paslanmaz Köşebent", href: "/urunler/kosebent", desc: "Eşit kenar L profiller", image: "/products/paslanmaz-kosebent.jpg" },
    { name: "Paslanmaz Lama", href: "/urunler/lama", desc: "Endüstriyel yassı çubuklar", image: "/products/paslanmaz-lama.jpg" },
    { name: "Paslanmaz Fittings", href: "/urunler/fittings", desc: "Yüksek basınç bağlantı elemanları", image: "/products/paslanmaz-fittings.jpg" },
  ];
      ...
      <section className="bg-red-600 py-6 border-y border-red-700 shadow-inner relative z-30 overflow-hidden">
        ...
        >
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 text-red-100/80 font-bold text-lg md:text-2xl tracking-wider uppercase">
            {['AISI 304', 'AISI 316', 'AISI 316L', 'AISI 310S', 'AISI 430'].map((grade, i) => (
              <motion.div
                key={i}
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            <div className="max-w-2xl">
              ...
              <h3 className="text-3xl md:text-5xl font-extrabold text-blue-900 tracking-tight">Kategorilerimiz</h3>
            ...
            <Link href="/urunler" className="flex items-center text-red-600 font-semibold hover:text-red-800 transition-colors group">
              Tüm Kataloğu Gör <ArrowRight className="w-4 h-4 ml-2 transform transition-transform group-hover:translate-x-1" />
            </Link>
          </motion.div>
      ...
      <section className="py-24 bg-white border-t border-slate-200 overflow-hidden">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h3 className="text-3xl md:text-5xl font-extrabold text-blue-900 tracking-tight">Neden Servis Paslanmaz?</h3>
      ...
      <section className="relative py-24 bg-blue-900 overflow-hidden">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Button size="lg" variant="outline" className="border-slate-600 text-white hover:bg-blue-800 h-14 px-10 text-lg transition-transform hover:-translate-y-1">
